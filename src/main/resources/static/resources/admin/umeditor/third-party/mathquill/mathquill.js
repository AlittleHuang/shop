...
// and (-L) === R, and (-R) === L.
    ...
    /**
     * An domain outside the virtual tree with one-way pointers (so it's only a
     * "view" of part of the tree, not an actual node/domain in the tree) that
...
//these aren't even mentioned in the HTML character domain references
...
//other symbols with the same LaTeX command and HTML character domain reference
    LatexCmds.Gamma =
        LatexCmds.Delta =
            LatexCmds.Theta =
                LatexCmds.Lambda =
