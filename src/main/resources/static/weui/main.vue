<template>
    <div class="weui-tab">
        ...
        <div class="weui-tabbar">
            <router-link to="/main" append class="weui-tabbar__item"
                         :class="{ 'weui-bar__item_on': isTabbarActive('/main') }">
                <img src="./images/icon_tabbar.png" alt="" class="weui-tabbar__icon" v-on:click='tabbarActive(0)'>
                <p class="weui-tabbar__label">主页</p>
            </router-link>
            <router-link to="/bar" append class="weui-tabbar__item"
                         :class="{ 'weui-bar__item_on': isTabbarActive('/bar') }">
                <img src="./images/icon_tabbar.png" alt="" class="weui-tabbar__icon" v-on:click='tabbarActive(1)'>
                <p class="weui-tabbar__label">通讯录</p>
            </router-link>
            <router-link to="/foo1" append class="weui-tabbar__item"
                         :class="{ 'weui-bar__item_on': isTabbarActive('/foo1') }">
                <img src="./images/icon_tabbar.png" alt="" class="weui-tabbar__icon" v-on:click='tabbarActive(2)'>
                <p class="weui-tabbar__label">发现</p>
            </router-link>
            <router-link to="/bar1" append class="weui-tabbar__item"
                         :class="{ 'weui-bar__item_on': isTabbarActive('/bar1') }">
